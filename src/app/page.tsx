...
const calculatorCategories = [
  ...
  {
    title: "Calendar",
    description: "Calendars, holidays, and historical date information",
    calculators: [
      {
        name: "Calendar 2026",
        description: "View the full calendar for 2026",
        path: "/calendar-2026",
        icon: Calendar,
        color: "primary",
      },
      {
        name: "Calendar 2027",
        description: "View the full calendar for 2027",
        path: "/calendar-2027",
        icon: Calendar,
        color: "secondary",
      },
      {
        ...
        description: "View and navigate monthly calendars",
        path: "/monthly-calendar",
        icon: CalendarCheck,
        color: "accent",
      },
      {
        name: "Printable Calendar (PDF)",
        description: "Generate and download printable calendars",
        path: "/printable-calendar",
        icon: Printer,
        color: "primary",
      },
      {
        name: "Add Your Own Calendar Events",
        description: "Create and manage personal calendar events",
      ...
      },
      {
        ...
        description: "Design custom calendars with your preferences",
      ...
      },
      {
        ...
        description: "Explore holidays from around the world",
      ...
      },
      {
        ...
        description: "Discover historical events for any date",
        path: "/on-this-day",
        icon: History,
        color: "secondary",
      },
      {
        name: "Fun Holidays",
        description: "Discover quirky and fun celebration days",
        path: "/fun-holidays",
        icon: Smile,
        color: "accent",
      },
      {
        ...
        description: "Information about each month",
        path: "/months-of-year",
        icon: LayoutGrid,
        color: "primary",
      },
      {
        ...
        description: "Learn about each day of the week",
        path: "/days-of-week",
        icon: Hash,
        color: "secondary",
      },
      {
        name: "About Leap Years",
        description: "Understanding leap years and their rules",
        path: "/leap-years",
        icon: HelpCircle,
        color: "accent",
      },
      {
        name: "Calendar & Holiday News",
        description: "Latest news about calendar changes and holidays",
        path: "/calendar-news",
        icon: ScrollText,
        color: "primary",
      },
  ...
  {
    title: "Time Zones",
    description: "Time zone tools, converters, and worldwide time information",
    calculators: [
      {
        name: "Time Zone Converter",
        description: "Convert time between different time zones",
      ...
      },
      {
        ...
        description: "Plan meetings across multiple time zones",
      ...
      },
      {
        ...
        description: "Share event times in multiple time zones",
        path: "/event-announcer",
        icon: Megaphone,
        color: "accent",
      },
      {
        name: "Time Zone Map",
        description: "Visual world map with time zones",
        path: "/timezone-map",
        icon: Map,
        color: "primary",
      },
      {
        ...
        description: "List of all time zone abbreviations",
        path: "/timezone-abbreviations",
        icon: List,
        color: "secondary",
      },
      {
        name: "Daylight Saving Time",
        description: "DST information and schedules worldwide",
        path: "/daylight-saving",
        icon: SunMoon,
        color: "accent",
      },
      {
        name: "Time Changes Worldwide",
        description: "Upcoming time changes around the world",
        path: "/time-changes",
        icon: Globe2,
        color: "primary",
      },
      {
        ...
        description: "Calculate time difference between locations",
      ...
      {
        name: "Time Zone News",
        description: "Latest news about time zone changes",
        path: "/timezone-news",
        icon: Newspaper,
        color: "accent",
      },
