      ...
      <main className="relative z-10 container mx-auto px-4 py-8 md:py-12">
        <header className="text-center mb-12 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-theme-primary/10 border border-theme-primary/20 mb-4">
            ...
            <span className="text-sm text-theme-primary">Year Calendar</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
            <span className="text-gradient">Calendar</span>{" "}
            <span className="text-theme-text">2026</span>
          </h1>
          <p className="text-lg text-theme-text-muted max-w-2xl mx-auto">
            Full year calendar for 2026 with all months
          </p>
        </header>
          ...
          <section className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {monthNames.map((month, monthIndex) => (
                <div
                  key={month}
                  className="glass-card p-4 cursor-pointer hover:border-theme-primary/50 transition-all"
                  ...
                  <div
                    ...
                    className={`text-center py-3 rounded-lg ${
                      day === null
                        ...
                        : "bg-theme-surface/50 text-theme-text hover:bg-theme-primary/20"
